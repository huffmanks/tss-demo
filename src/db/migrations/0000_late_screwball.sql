...
CREATE TABLE "instructions" (
	...
	"recipe_id" uuid NOT NULL,
	"name" text NOT NULL,
	"isHeading" boolean DEFAULT false NOT NULL,
	"order" integer NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "recipe_instructions" ADD CONSTRAINT "recipe_instructions_instruction_id_instructions_id_fk" FOREIGN KEY ("instruction_id") REFERENCES "public"."instructions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
